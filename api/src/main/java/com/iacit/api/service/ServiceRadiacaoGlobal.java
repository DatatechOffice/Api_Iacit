...
public class ServiceRadiacaoGlobal {
	...
	public void insBancoService(ArrayList<String> listaEstacaoCodigo, ArrayList<String> estTdata, ArrayList<String> estRadiacaoGlobal) {
		...
		for (int i = 1; i < ii; i++) {
			...
			if (estRadGlobal.isEmpty()) {
				...
				RadiacaoGlobal radiacaoGlobal = new RadiacaoGlobal(estacao, Timestamp.valueOf(estData_+":00"), BigDecimal.valueOf(Float.parseFloat(estRadGlobal)));
