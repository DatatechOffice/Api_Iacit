...
public class Estacao {
	public Estacao(Estado etdId, String estCodigo, BigDecimal estLongitude, String estNomeEstacao,
			Timestamp estDataFundacao, BigDecimal estLatitude, BigDecimal estAltitude) {
